      ...
      <div class='card-body'>
        ${
          url
            ...
            : `
      <img width='100%' height='150px' style="object-fit: cover; object-position: center" src="default.png" alt='card image cap' class='img-fluid place__holder__image mb-3' />
      `
        }
...
const htmlModalContent = ({ id, title, description, url }) => {
  ...
  return `
    ...
    ${
      ...
      `
        : `
      <img width='100%' src="default.png" alt='card image cap' class='img-fluid place__holder__image mb-3' />
      `
    }
